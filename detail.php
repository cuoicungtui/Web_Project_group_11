...
<div class="container">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="content">
        <p>Với những hành trình bay bằng phản lực Embraer của Bamboo Airways, lần đầu tiên trong lịch sử, khoảng cách gần 2000km giữa TP HCM và Điện Biên sẽ chỉ còn gói gọn trong hơn 2 giờ bay thẳng.</p>
        ...
        <p>Ngay khi đi vào hoạt động, đường bay thẳng TP. HCM – Điện Biên của Bamboo Airways sẽ góp phần rút ngắn đáng kể thời gian di chuyển giữa 2 thành phố ở hai đầu đất nước. Dự kiến, tổng thời gian hành trình bay giữa TP. HCM – Điện Biên khai thác bằng máy bay phản lực Embraer của Bamboo Airways sẽ chỉ còn hơn 2 tiếng đồng hồ.</p>
      </div>

      <div class="image d-flex">
        <img src="./assets/img/d1.png" alt="">
        <span>Ảnh 1: Thời gian di chuyển giữa 2 thành phố ở 2 đầu đất nước được rút ngắn đáng kể bằng các chuyến bay thẳng của Bamboo Airways</span>
      </div>
      ...
      <div class="image">
        ...
        <span>Ảnh 2: Bamboo Airways tung loạt ưu đãi hấp dẫn mừng mở bán đường bay thẳng lịch sử TP HCM – Điện Biên</span>
      </div>
      ...
      <h5 class="d-flex justify-content-center">HAHALOLO luôn sát cánh trên mọi chuyến bay của bạn.</h5>
      <div class="contact">
        ...
        <div class="contact-sdt">Tổng đài đặt vé: 1900 57 12 48</div>
        <p>
          Website đặt vé:
          <a href="#" class="contact-link">VÉ MÁY BAY HAHALOLO</a>
        </p>
        <p>
          Website hỗ trợ:
          <a href="#" class="contact-link">TRUNG TÂM CHĂM SÓC KHÁCH HÀNG HAHALOLO </a>
        </p>
      </div>
    </div>
  </div>
