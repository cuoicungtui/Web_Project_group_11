                                        ...
                                        <div class="col-md-6 col-lg-3 mb-2">
                                            <div class="ticket-logo">
                                                ...
                                                <div class="ticket-price">
                                                    ...
                                                    ?>
                                                    <a href="information.php?adult=<?php echo $adult?>&children=<?php echo $children?>&baby=<?php echo $baby?>&flight=<?php echo $row['Code_Flight']?>&1&location1=<?php echo $location1?>&totalPrice=<?php echo $totalPrice ?>">
