                        ...
                        <div class="tab-pane active">
                            <div class="container">
                                ...
                                <div class="tab-search">
                                    <a href="ticket1.php" class="btn-bookT" style="color: #fff; text-decoration: none;">Tìm kiếm</a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane">
                            <div class="container">
                                ...
                                <div class="tab-search">
                                    <a href="#" class="btn-bookT" style="color: #fff; text-decoration: none;">Tìm kiếm</a>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane">
